    ...
    return (
        <section className='flex flex-col gap-y-3 md:gap-y-5  items-center justify-center w-full'>
            ...
            <div className='flex flex-col items-center justify-center w-full '>
                <h1 className='md:text-6xl lg:text-7xl text-4xl font-bold text-goViolet-500 text-center '>Website Builder</h1>
                <h1 className='md:text-6xl lg:text-7xl   text-4xl font-bold text-goGreen-500 text-center '>For Healthcare Facilitators</h1>
            </div>
            <div className='flex flex-col items-center justify-center w-full '>
