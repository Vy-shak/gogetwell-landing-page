...
function Solutions() {
  return (
    <section className='w-full flex-col justify-center items-center flex'>
        ...
        <div className='flex gap-y-3 items-center justify-center w-full flex-wrap'>
            ...
            <div className='w-full gap-x-3 flex-col md:flex-row  items-center justify-center flex'>
